...
export default function CreatePage() {
  ...
  let createHandler = async (e) => {
    e.preventDefault();
    setIsPending(true);
    let newGame = { ...formData, imageUrl, authorEmail: email };

    let data = await create(newGame);
    setIsPending(false);
      ...
      <div className="form-box">
        ...
        <form onSubmit={createHandler}>
          ...
          <div className="input-group">
            ...
            <input id="game-cover" name="imageUrl" type="file" accept="image/*" onChange={fileChangeHandler} className="input-field" />
